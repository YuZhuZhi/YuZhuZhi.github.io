...
(1)*同一律*：$
A and 1 equiv A   A or 0 equiv A
$
(2)*零律*：$
A and 0 equiv 0   A or 1 equiv 1
$
(3)*矛盾律*：$
A and ( not A) equiv 0
$
...
$
(6)*幂等律*：$
A and A equiv A,  A or A equiv A
$
(7)*交换律*：$
A and B equiv B and A   A or B equiv B or A
$
(8)*结合律*：$
A and (B and C) equiv (A and B) and C   A or (B or C) equiv (A or B) or C
$
(9)*分配律*：$
A and (B or C) equiv (A and B) or (A and C)   A or (B and C) equiv (A or B) and (A or C)
$
(10)*吸收律*：$
A and (A or B) equiv A   A or (A and B) equiv A
$
(11)*德摩根律*：$
 not (A and B) equiv ( not A) or( not B)    not (A or B) equiv ( not A) and( not B)
$
(12)*蕴涵等值式*：$
...
当推理的结论是*蕴涵式*时，仅靠(*四、2*)中 $(1) ~(6)$ 的推理规则是无法论证的。但是由于：
