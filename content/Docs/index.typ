...
#html.elem(
  ...
  #html.elem("section", attrs: (class: "docs-tab-panel docs-tab-panel-math"))[
    ...
    = *概率论与数理统计* #footnote[盛骤, 谢式千, 潘承毅. 概率论与数理统计[M]. 5版. 北京: 高等教育出版社, 2019.]
    ...
    = *信号与系统* #footnote[Oppenheim A V, Willsky A S, Nawab S H. 信号与系统[M]. 2版. 刘树棠, 译. 北京: 电子工业出版社, 2013.]
    ...
    = *离散数学* #footnote[周晓聪, 乔海燕. 离散数学基础[M]. 北京: 清华大学出版社, 2021.]
    ...
    = *泛函分析* #footnote[刘炳初. 泛函分析[M]. 3版. 北京: 科学出版社, 2015.]
      + #link("数学/泛函分析/距离空间")[距离空间]
  ]
  ...
  #html.elem("section", attrs: (class: "docs-tab-panel docs-tab-panel-computer"))[
    = *数据结构与算法（Rust 演示）*
      + #link("计算机/数据结构与算法/顺序表与链表，栈与队列/")[顺序表与链表，栈与队列]
      + #link("计算机/数据结构与算法/哈希表/")[哈希表]
      + #link("计算机/数据结构与算法/树与堆/")[树与堆]
      + #link("计算机/数据结构与算法/排序算法/")[排序算法]
      + #link("计算机/数据结构与算法/查找算法/")[查找算法]
      + #link("计算机/数据结构与算法/图与并查集/")[图与并查集]
      + #link("计算机/数据结构与算法/字符串算法/")[字符串算法]
      + #link("计算机/数据结构与算法/高精度数与大数乘法/")[高精度数与大数乘法]

    #html.hr()

    = *数字图像处理* #footnote[Gonzalez R C, Woods R E. 数字图像处理[M]. 3版. 阮秋琦, 阮宇智, 译. 北京: 电子工业出版社, 2020.]
      + #link("计算机/数字图像处理/数字图像基础/")[数字图像基础]
      + #link("计算机/数字图像处理/灰度变换/")[灰度变换]
      + #link("计算机/数字图像处理/空间滤波/")[空间滤波]
      + #link("计算机/数字图像处理/傅里叶变换/")[傅里叶变换]
      + #link("计算机/数字图像处理/频域滤波/")[频域滤波]
      + #link("计算机/数字图像处理/图像复原/")[图像复原]
      + #link("计算机/数字图像处理/彩色图像/")[彩色图像]
      + #link("计算机/数字图像处理/形态学图像处理/")[形态学图像处理]
      + #link("计算机/数字图像处理/图像分割/")[图像分割]
      + #link("计算机/数字图像处理/特征提取与图像拼接/")[特征提取与图像拼接]

    #html.hr()

    = *计算机图形学 · 光线追踪（Rust 实现的路径追踪）*
